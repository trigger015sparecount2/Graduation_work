...
HRESULT CSky::Init(D3DXVECTOR3 pos)
{
	...
	//頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(0.0f, 20000.0f, 0.0f); //てっぺん
	pVtx[1].pos = D3DXVECTOR3(-12000.0f, 14000.0f, 8000.0f);
	pVtx[2].pos = D3DXVECTOR3(-12000.0f, 14000.0f, -8000.0f);
	pVtx[3].pos = D3DXVECTOR3(0.0f, 14000.0f, -14000.0f);
	pVtx[4].pos = D3DXVECTOR3(12000.0f, 14000.0f, -8000.0f);
	pVtx[5].pos = D3DXVECTOR3(12000.0f, 14000.0f, 8000.0f);
	pVtx[6].pos = D3DXVECTOR3(0.0f, 14000.0f, 14000.0f);
	pVtx[7].pos = D3DXVECTOR3(-12000.0f, 14000.0f, 8000.0f);//上
